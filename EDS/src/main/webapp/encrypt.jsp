...
%>
	...
	<section class="section-form">
		<div class="row">
			<h2><%=bean.getFirstName()+" " %>Paste/ Write your text in below Text Box</h2>
			<div class="row">
				 <form method="post" action="encryptCtl" class="contact-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col span-2-of-3">
                                <textarea name="text" id="text" placeholder="Paste your text in the box...." rows="10" cols="50"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col span-2-of-3">
                                <input type="submit" name="operation" id="operation" value="Encrypt it!">
                            </div>
                        </div>
