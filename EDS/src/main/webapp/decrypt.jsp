		...
		<nav>
			<div class="row">
				...
				<ul class="main-nav js--main-nav">
					<li><a href="encrypt.jsp">Encrypt My Text</a></li>
					<li><a href="decrypt.jsp">Decrypt My Text</a></li>
...
%>
	...
	<section class="section-form">
		<div class="row">
			<h2><%=bean.getFirstName()+" " %>Paste/ Write your text in below
				Text Box
			</h2>
			<div class="row">
				<form method="post" action="decryptCtl" class="contact-form">

					<div class="row">
						<div class="col span-1-of-6">
							<label for="msg">Public Key</label>
						</div>
						<div class="col span-2-of-3">
						<input type="text" name="publicKey" id="publicKey"
								placeholder="Enter the public key" required>
						</div>
					</div>
					
					<div class="row">
						<div class="col span-1-of-6">
							<label for="msg">Write Here</label>
						</div>
						<div class="col span-2-of-3">
							<textarea name="text" id="text"
								placeholder="Paste your text in the box...." rows="4" cols="50"></textarea>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col span-2-of-3">
							<input type="submit" name="operation" id="operation" value="Decrypt it!">
						</div>
					</div>
